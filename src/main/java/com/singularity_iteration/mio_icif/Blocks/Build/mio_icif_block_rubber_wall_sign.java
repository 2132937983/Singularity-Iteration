...
public class mio_icif_block_rubber_wall_sign extends WallSignBlock {
    public mio_icif_block_rubber_wall_sign(Properties properties) {
        super(mio_icif_block_rubber_sign.RUBBER_WOOD_TYPE, properties);
    }
    
    public mio_icif_block_rubber_wall_sign() {
