...
public class mio_icif_hazmat_boots extends ArmorItem implements IHazmatLike {
    ...
    private static final ResourceLocation HAZMAT_ARMOR_TEXTURE = 
        ResourceLocation.fromNamespaceAndPath("mio_icif", "textures/armor/rubber_1.png");

    public mio_icif_hazmat_boots(Holder<ArmorMaterial> material, Properties properties) {
