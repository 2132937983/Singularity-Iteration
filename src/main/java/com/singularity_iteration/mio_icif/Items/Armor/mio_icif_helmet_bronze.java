...
public class mio_icif_helmet_bronze extends ArmorItem implements IMetalArmor {
    ...
    public mio_icif_helmet_bronze(Holder<ArmorMaterial> material, Properties properties) {
