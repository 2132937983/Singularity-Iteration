...
public class mio_icif_thorium_scrapbox extends Item {
    ...
    public mio_icif_thorium_scrapbox(Properties properties) {
        super(properties);
    }
    ...
    public static void registerDispenserBehavior() {
        DispenserBlock.registerBehavior(mio_icif_resources.THORIUM_SCRAP.get(), new DefaultDispenseItemBehavior() {
            @Override
            protected ItemStack execute(BlockSource source, ItemStack stack) {
                mio_icif_thorium_scrapbox scrapbox = (mio_icif_thorium_scrapbox) stack.getItem();
