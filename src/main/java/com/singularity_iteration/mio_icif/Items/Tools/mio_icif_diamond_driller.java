 ...
 * 钻石钻头
 * 继承电力工具基础类，使用电力驱动
 * 具有钻石镐的一切性质，不会因耐久度为0而损坏?
 * 有电时破坏速度与钻石镐相当，没电时速度变得跟手挖一样快
 * 能量容量比铁钻头更高
 */
@SuppressWarnings("null")
public class mio_icif_diamond_driller extends mio_icif_tool_elc implements IMiningDrill {

    // 钻石钻头默认最大能量?(IC2原版: 30000 EU)
    public static final int DIAMOND_DRILLER_MAX_ENERGY = 30000;

    // 钻石钻头传输限制 (IC2原版: 100 EU/t)
    public static final int DIAMOND_DRILLER_TRANSFER_LIMIT = 100;

    // 钻石钻头每次使用消耗的能量 (IC2原版: 80 EU)
    public static final int DIAMOND_DRILLER_ENERGY_PER_USE = 80;

    // 钻石钻头的攻击伤�?(IC2原版: 2.0, ItemElectricTool基类damage=2.0)
    public static final float DIAMOND_DRILLER_ATTACK_DAMAGE = 2.0F;

    // 钻石钻头的挖掘效果?(IC2原版: 16.0)
     ...
     */
    public mio_icif_diamond_driller(Properties properties) {
        super(properties, DIAMOND_DRILLER_MAX_ENERGY, DIAMOND_DRILLER_MAX_ENERGY, "diamond_driller", DIAMOND_DRILLER_TRANSFER_LIMIT, DIAMOND_DRILLER_ENERGY_PER_USE, 3);
    }
    ...
    public mio_icif_diamond_driller(Properties properties, int initialEnergy) {
        super(properties, DIAMOND_DRILLER_MAX_ENERGY, DIAMOND_DRILLER_MAX_ENERGY - initialEnergy, "diamond_driller", DIAMOND_DRILLER_TRANSFER_LIMIT, DIAMOND_DRILLER_ENERGY_PER_USE, 3);
    }
    ...
    public float getAttackDamageBonus(Entity target, float damage, DamageSource damageSource) {
        return DIAMOND_DRILLER_ATTACK_DAMAGE;
    }
    ...
    public float getDestroySpeed(ItemStack stack, BlockState state) {
        ...
        if (state.is(net.minecraft.tags.BlockTags.MINEABLE_WITH_PICKAXE)) {
            return DIAMOND_DRILLER_EFFICIENCY;
        }
    ...
    public long energyUse(ItemStack stack, BlockGetter world, BlockPos pos, BlockState state) {
        return DIAMOND_DRILLER_ENERGY_PER_USE;
    }
