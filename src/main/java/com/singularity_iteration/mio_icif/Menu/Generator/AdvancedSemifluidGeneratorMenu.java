...
public class AdvancedSemifluidGeneratorMenu extends mio_icif_generator_menu {
    ...
    public AdvancedSemifluidGeneratorMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, null, null, null);
    }

    public AdvancedSemifluidGeneratorMenu(int containerId, Inventory playerInventory,
                                   @Nullable mio_icif_advanced_semifluid_generator blockEntity,
                                   @Nullable IItemHandler itemHandler,
                                   @Nullable ContainerData data) {
        super(mio_icif_menus.ADVANCED_SEMIFLUID_GENERATOR_MENU_TYPE.get(), containerId, SLOT_COUNT,
    ...
    protected void addMachineSlots() {
        this.addSlot(new SlotItemHandler(itemHandler, FUEL_BUCKET_SLOT, 27, 21) {
            ...
            public boolean mayPlace(ItemStack stack) {
                ...
                if (blockEntity instanceof mio_icif_advanced_semifluid_generator gen && gen.getFuelAmount() >= gen.getFuelCapacity()) return false;
                return true;
            }
        });
    ...
    public void broadcastChanges() {
        ...
        if (blockEntity instanceof mio_icif_advanced_semifluid_generator gen) {
