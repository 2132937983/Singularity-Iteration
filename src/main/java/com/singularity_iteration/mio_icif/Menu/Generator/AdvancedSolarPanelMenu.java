...
public class AdvancedSolarPanelMenu extends mio_icif_generator_menu {
    ...
    public final mio_icif_AdvancedSolarPanel blockEntity;

    public AdvancedSolarPanelMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, null);
    }

    public AdvancedSolarPanelMenu(int containerId, Inventory playerInventory, @Nullable mio_icif_AdvancedSolarPanel blockEntity) {
        super(mio_icif_menus.ADVANCED_SOLAR_PANEL_MENU_TYPE.get(), containerId, SLOT_COUNT,
            playerInventory,
    ...
    protected void addChargingSlot(int index, int x, int y) {
        this.addSlot(new net.neoforged.neoforge.items.SlotItemHandler(itemHandler, index, x, y) {
            ...
            public boolean mayPlace(ItemStack stack) {
                return AdvancedSolarPanelMenu.this.isBattery(stack);
            }
    ...
    public void broadcastChanges() {
        ...
        if (blockEntity != null) {
            ...
            this.setSyncData(3, blockEntity.getGenerationState() == mio_icif_AdvancedSolarPanel.GenerationState.DAY ? 1 : 0);
        }
    }
}