...
public class ExperienceGeneratorMenu extends mio_icif_generator_menu {
    public static final int SLOT_COUNT = 0;
    public static final int DATA_COUNT = 4;

    public ExperienceGeneratorMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, null);
    }

    public ExperienceGeneratorMenu(int containerId, Inventory playerInventory,
                              @Nullable mio_icif_experience_generator blockEntity) {
        super(mio_icif_menus.EXPERIENCE_GENERATOR_MENU_TYPE.get(), containerId, SLOT_COUNT,
    ...
    public void broadcastChanges() {
        ...
        if (blockEntity instanceof mio_icif_experience_generator gen) {
