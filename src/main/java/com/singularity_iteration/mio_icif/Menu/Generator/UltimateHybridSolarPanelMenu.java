...
public class UltimateHybridSolarPanelMenu extends mio_icif_generator_menu {
    ...
    public final mio_icif_UltimateHybridSolarPanel blockEntity;

    public UltimateHybridSolarPanelMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, null);
    }

    public UltimateHybridSolarPanelMenu(int containerId, Inventory playerInventory, @Nullable mio_icif_UltimateHybridSolarPanel blockEntity) {
        super(mio_icif_menus.ULTIMATE_HYBRID_SOLAR_PANEL_MENU_TYPE.get(), containerId, SLOT_COUNT,
            playerInventory,
    ...
    protected void addChargingSlot(int index, int x, int y) {
        this.addSlot(new net.neoforged.neoforge.items.SlotItemHandler(itemHandler, index, x, y) {
            ...
            public boolean mayPlace(ItemStack stack) {
                return UltimateHybridSolarPanelMenu.this.isBattery(stack);
            }
    ...
    public void broadcastChanges() {
        ...
        if (blockEntity != null) {
            ...
            this.setSyncData(3, blockEntity.getGenerationState() == mio_icif_UltimateHybridSolarPanel.GenerationState.DAY ? 1 : 0);
        }
    }
}