...
public class UltimatePhotonResonanceSolarGeneratorMenu extends mio_icif_generator_menu {
    ...
    public final mio_icif_UltimatePhotonResonanceSolarGenerator blockEntity;

    public UltimatePhotonResonanceSolarGeneratorMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, null);
    }

    public UltimatePhotonResonanceSolarGeneratorMenu(int containerId, Inventory playerInventory, @Nullable mio_icif_UltimatePhotonResonanceSolarGenerator blockEntity) {
        super(mio_icif_menus.ULTIMATE_PHOTON_RESONANCE_SOLAR_GENERATOR_MENU_TYPE.get(), containerId, SLOT_COUNT,
            playerInventory,
