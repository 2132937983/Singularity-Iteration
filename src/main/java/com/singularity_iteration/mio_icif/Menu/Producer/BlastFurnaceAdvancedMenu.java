...
public class BlastFurnaceAdvancedMenu extends mio_icif_machine_menu {
    ...
    public BlastFurnaceAdvancedMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, null, null);
    }

    public BlastFurnaceAdvancedMenu(int containerId, Inventory playerInventory, @Nullable net.neoforged.neoforge.items.IItemHandler itemHandler) {
        this(containerId, playerInventory, itemHandler, null);
    }

    public BlastFurnaceAdvancedMenu(int containerId, Inventory playerInventory, @Nullable net.neoforged.neoforge.items.IItemHandler itemHandler, @Nullable ContainerData data) {
        super(mio_icif_menus.BLAST_FURNACE_ADVANCED_MENU_TYPE.get(), containerId, SLOT_COUNT, playerInventory, itemHandler, data, 6);
    }

    public BlastFurnaceAdvancedMenu(int containerId, Inventory playerInventory, @Nullable mio_icif_blast_furnace_advanced blockEntity) {
        super(mio_icif_menus.BLAST_FURNACE_ADVANCED_MENU_TYPE.get(), containerId, SLOT_COUNT, playerInventory,
