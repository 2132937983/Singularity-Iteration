...
public class PowderElcMenu extends mio_icif_machine_menu {
    ...
    public final mio_icif_powder_elc blockEntity;

    public PowderElcMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, null);
    }

    public PowderElcMenu(int containerId, Inventory playerInventory, @Nullable mio_icif_powder_elc blockEntity) {
        super(mio_icif_menus.POWDER_ELC_MENU_TYPE.get(), containerId, SLOT_COUNT,
            playerInventory,
    ...
    public boolean stillValid(Player player) {
        return this.access.evaluate((level, pos) ->
            level.getBlockState(pos).getBlock() instanceof com.singularity_iteration.mio_icif.Blocks.Producer.mio_icif_block_powder_elc
