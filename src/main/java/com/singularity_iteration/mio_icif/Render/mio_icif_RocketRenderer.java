...
public class mio_icif_RocketRenderer extends EntityRenderer<mio_icif_rocket_entity> {

    public static final ResourceLocation ROCKET_TEXTURE = ResourceLocation.fromNamespaceAndPath(
        "mio_icif", "textures/entity/rocket.png"
    );

    public mio_icif_RocketRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(mio_icif_rocket_entity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(mio_icif_rocket_entity entity) {
