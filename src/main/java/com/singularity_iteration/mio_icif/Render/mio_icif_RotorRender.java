...
public class mio_icif_RotorRender implements BlockEntityRenderer<mio_icif_Wind_Kinetic_Generator> {
    ...
    public mio_icif_RotorRender(BlockEntityRendererProvider.Context context) {
    }

    @Override
    public void render(mio_icif_Wind_Kinetic_Generator blockEntity, float partialTick, PoseStack poseStack,
        ...
        float rotorHeight = texturePixelHeight * PIXEL_SCALE;
        ...
        // 计算旋转速度：与MCU成正比，100 MCU = 15 旋转速度
        int currentMCU = blockEntity.getCurrentMCU();
        float rotationSpeed = currentMCU * 15.0f / 100.0f;
    ...
    @Override
    public boolean shouldRenderOffScreen(mio_icif_Wind_Kinetic_Generator blockEntity) { return true; }
}