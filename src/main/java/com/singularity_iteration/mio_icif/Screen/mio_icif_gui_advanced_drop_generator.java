...
import com.singularity_iteration.mio_icif.Menu.Generator.AdvancedDropGeneratorMenu;
...
public class mio_icif_gui_advanced_drop_generator extends mio_icif_screen<AdvancedDropGeneratorMenu> {
    ...
    public mio_icif_gui_advanced_drop_generator(AdvancedDropGeneratorMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        AdvancedDropGeneratorMenu menu = this.menu;
        if (menu != null) {
            ...
            String infoText = "Fuel:" + menu.getFuel() + "/EU:" + menu.getEnergy();
