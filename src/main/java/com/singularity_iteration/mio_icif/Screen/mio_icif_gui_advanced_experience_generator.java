...
import com.singularity_iteration.mio_icif.Menu.Generator.AdvancedExperienceGeneratorMenu;
...
public class mio_icif_gui_advanced_experience_generator extends mio_icif_screen<AdvancedExperienceGeneratorMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        AdvancedExperienceGeneratorMenu menu = this.menu;
        if (menu != null) {
