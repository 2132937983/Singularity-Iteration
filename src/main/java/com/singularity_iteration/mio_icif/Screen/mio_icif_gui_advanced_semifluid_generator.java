...
import com.singularity_iteration.mio_icif.Menu.Generator.AdvancedSemifluidGeneratorMenu;
...
public class mio_icif_gui_advanced_semifluid_generator extends mio_icif_screen<AdvancedSemifluidGeneratorMenu> {
    ...
    public mio_icif_gui_advanced_semifluid_generator(AdvancedSemifluidGeneratorMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        AdvancedSemifluidGeneratorMenu menu = this.menu;
        if (menu != null) {
