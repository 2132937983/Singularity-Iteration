...
public class mio_icif_gui_compressor_advanced_elc extends mio_icif_screen<CompressorAdvancedElcMenu> {
    ...
    public mio_icif_gui_compressor_advanced_elc(CompressorAdvancedElcMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        CompressorAdvancedElcMenu menu = this.getMenu();
        if (menu != null) {
