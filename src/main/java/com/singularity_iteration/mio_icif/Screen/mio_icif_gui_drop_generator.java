...
import com.singularity_iteration.mio_icif.Menu.Generator.DropGeneratorMenu;
...
public class mio_icif_gui_drop_generator extends mio_icif_screen<DropGeneratorMenu> {
    ...
    public mio_icif_gui_drop_generator(DropGeneratorMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        DropGeneratorMenu menu = this.menu;
        if (menu != null) {
