...
public class mio_icif_gui_geomagnetic_generator extends mio_icif_screen<com.singularity_iteration.mio_icif.Menu.Generator.GeomagneticGeneratorMenu> {

    private static final ResourceLocation GUI_TEXTURE =
        ResourceLocation.parse("mio_icif:textures/gui/gui_geomagnetic_generator.png");
    ...
    public mio_icif_gui_geomagnetic_generator(com.singularity_iteration.mio_icif.Menu.Generator.GeomagneticGeneratorMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        com.singularity_iteration.mio_icif.Menu.Generator.GeomagneticGeneratorMenu menu = this.getMenu();
