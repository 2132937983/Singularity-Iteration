 ...
 *
 * 特性：
 * - 54 个槽位（大箱子大小）用于存储青金石块
 * - 显示能量状态
 * - 显示青金石块数量
 */
@OnlyIn(Dist.CLIENT)
public class mio_icif_gui_lapis_reactor_coolant_injector extends mio_icif_screen<com.singularity_iteration.mio_icif.Menu.Producer.LapisReactorCoolantInjectorMenu> {
    ...
    public mio_icif_gui_lapis_reactor_coolant_injector(com.singularity_iteration.mio_icif.Menu.Producer.LapisReactorCoolantInjectorMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        com.singularity_iteration.mio_icif.Menu.Producer.LapisReactorCoolantInjectorMenu menu = this.menu;
        if (menu != null) {
            // 绘制能量条（从下往上填充）
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        guiGraphics.drawString(this.font,
            Component.translatable("gui.mio_icif.lapis_injector.lapis_blocks", menu.getLapisBlockCount()),
            28, 6, 0x404040, false);
    }
