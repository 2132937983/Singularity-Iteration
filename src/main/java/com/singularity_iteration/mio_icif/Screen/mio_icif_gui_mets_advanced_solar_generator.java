...
public class mio_icif_gui_mets_advanced_solar_generator extends mio_icif_screen<MetsAdvancedSolarGeneratorMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        MetsAdvancedSolarGeneratorMenu menu = this.getMenu();
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        if (mouseX >= x + SUN_ICON_X && mouseX <= x + SUN_ICON_X + SUN_ICON_WIDTH &&
            ...
            Component tooltip = menu.isGenerating() ?
                Component.literal("Generating: 64 EU/t") :
