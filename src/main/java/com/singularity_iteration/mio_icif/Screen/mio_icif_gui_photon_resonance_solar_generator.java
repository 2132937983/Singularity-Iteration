...
public class mio_icif_gui_photon_resonance_solar_generator extends mio_icif_screen<PhotonResonanceSolarGeneratorMenu> {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        PhotonResonanceSolarGeneratorMenu menu = this.getMenu();
    ...
    protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        ...
        if (mouseX >= x + SUN_ICON_X && mouseX <= x + SUN_ICON_X + SUN_ICON_WIDTH &&
            ...
            Component tooltip = menu.isGenerating() ?
                Component.literal("Generating: 512 EU/t") :
