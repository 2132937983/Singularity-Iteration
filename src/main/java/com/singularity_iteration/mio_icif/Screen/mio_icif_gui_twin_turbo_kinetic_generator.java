...
public class mio_icif_gui_twin_turbo_kinetic_generator extends mio_icif_screen<com.singularity_iteration.mio_icif.Menu.Generator.TwinTurboKineticGeneratorMenu> {
    ...
    public mio_icif_gui_twin_turbo_kinetic_generator(com.singularity_iteration.mio_icif.Menu.Generator.TwinTurboKineticGeneratorMenu menu, Inventory playerInventory, Component title) {
    ...
    protected void renderBg(GuiGraphics guiGraphics, float partialTick, int mouseX, int mouseY) {
        ...
        com.singularity_iteration.mio_icif.Menu.Generator.TwinTurboKineticGeneratorMenu menu = this.menu;
        if (menu != null) {
            ...
            String infoText = Component.translatable("gui.mio_icif.twin_turbo_kinetic_generator.efficiency", 120).getString();
