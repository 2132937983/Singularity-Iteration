...
public class PlantBlackthorn extends PlantType {
    ...
    public String[] getTraits() {
        return new String[]{"Black", "Flower", "Ink"};
    }

    @Override
    public PlantStats getStats() {
        return new PlantStats(2, 0, 2, 0, 2, 0);
    }
    ...
    public ItemStack[] getHarvest(IPlanter planter) {
        return new ItemStack[]{new ItemStack(Items.INK_SAC, 1)};
    }
