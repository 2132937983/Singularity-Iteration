...
public class PlantRose extends PlantType {
    ...
    public String[] getTraits() {
        return new String[]{"Red", "Flower", "Rose"};
    }
    ...
    public ItemStack[] getHarvest(IPlanter planter) {
        return new ItemStack[]{new ItemStack(Items.POPPY, 1)};
    }
    ...
    public String getTexture(int stage) {
        ...
        return "mio_icif:block/crop/rose_" + stage;
    }
