...
public class LapotronCrystalBeltCurio extends MioIcifTrinketBase {

    private static final int STORAGE_ENERGY = 20000000;
    private static final int TRANSFER_SPEED = 2048;
    private static final int TIER = 4;

    public LapotronCrystalBeltCurio() {
        super(new Item.Properties().stacksTo(1), STORAGE_ENERGY, 0, "lapotron_crystal_belt", STORAGE_ENERGY, 0, TIER, "belt");
    }
