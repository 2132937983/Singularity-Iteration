...
public class mio_icif_CuttingCategory implements IRecipeCategory<mio_icif_CuttingRecipe> {

    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(Singularity_Iteration.MOD_ID, "cutting");
    ...
    public static final RecipeType<mio_icif_CuttingRecipe> CUTTING_TYPE =
            new RecipeType<>(UID, mio_icif_CuttingRecipe.class);

    private final IDrawable background;
    private final IDrawable icon;

    public mio_icif_CuttingCategory(IGuiHelper helper) {
        // 背景只绘制机器内容区域，去掉边框
    ...
    @Override
    public RecipeType<mio_icif_CuttingRecipe> getRecipeType() {
        return CUTTING_TYPE;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, mio_icif_CuttingRecipe recipe, IFocusGroup focuses) {
    ...
    @Override
    public void draw(mio_icif_CuttingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
