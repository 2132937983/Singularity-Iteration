...
public class mio_icif_ExtrudingCategory implements IRecipeCategory<mio_icif_ExtrudingRecipe> {

    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(Singularity_Iteration.MOD_ID, "extruding");
    ...
    public static final RecipeType<mio_icif_ExtrudingRecipe> EXTRUDING_TYPE =
            new RecipeType<>(UID, mio_icif_ExtrudingRecipe.class);

    private final IDrawable background;
    private final IDrawable icon;

    public mio_icif_ExtrudingCategory(IGuiHelper helper) {
        // 背景只绘制机器内容区域，去掉边框
    ...
    @Override
    public RecipeType<mio_icif_ExtrudingRecipe> getRecipeType() {
        return EXTRUDING_TYPE;
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, mio_icif_ExtrudingRecipe recipe, IFocusGroup focuses) {
        // 修复：使�?addItemStacks 并设置正确的数量，而不�?addIngredients
    ...
    @Override
    public void draw(mio_icif_ExtrudingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
