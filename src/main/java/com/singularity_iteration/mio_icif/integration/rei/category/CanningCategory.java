...
import com.singularity_iteration.mio_icif.integration.rei.display.CanningDisplay;
...
public class CanningCategory implements DisplayCategory<CanningDisplay> {
    ...
    public static final CategoryIdentifier<CanningDisplay> TYPE = CategoryIdentifier.of(Singularity_Iteration.MOD_ID, "canning");
