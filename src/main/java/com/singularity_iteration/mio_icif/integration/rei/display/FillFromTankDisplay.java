...
import com.singularity_iteration.mio_icif.integration.rei.category.FillFromTankCategory;
...
public class FillFromTankDisplay extends BasicDisplay {

    public FillFromTankDisplay(RecipeHolder<FillFromTankRecipe> recipe) {
        super(
    ...
    public CategoryIdentifier<?> getCategoryIdentifier() {
        return FillFromTankCategory.TYPE;
    }
}