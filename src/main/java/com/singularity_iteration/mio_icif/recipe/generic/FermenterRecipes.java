...
public class FermenterRecipes {
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<FermenterRecipe>> FERMENTER_TYPE =
        RECIPE_TYPES.register("fermenter", () -> new RecipeType<FermenterRecipe>() {
            @Override
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<AbstractSingleInputRecipe<mio_icif_SingleItemRecipeInput>>> FERMENTER_SERIALIZER =
        RECIPE_SERIALIZERS.register("fermenter", () -> new GenericSingleInputRecipeSerializer());
