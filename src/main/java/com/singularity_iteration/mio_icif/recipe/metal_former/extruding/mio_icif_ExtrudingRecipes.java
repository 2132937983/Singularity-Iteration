...
public class mio_icif_ExtrudingRecipes {
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<mio_icif_ExtrudingRecipe>> EXTRUDING_TYPE =
        RECIPE_TYPES.register("metal_former_extruding", () -> new RecipeType<mio_icif_ExtrudingRecipe>() {
            @Override
            public String toString() {
                return "metal_former_extruding";
            }
        });

    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<mio_icif_ExtrudingRecipe>> EXTRUDING_SERIALIZER =
        RECIPE_SERIALIZERS.register("metal_former_extruding", mio_icif_ExtrudingRecipeSerializer::new);
